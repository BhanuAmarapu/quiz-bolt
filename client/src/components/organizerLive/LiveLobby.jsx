...
const LiveLobby = ({ activeQuiz, participants, navigate, startQuizBroadcast, showToast }) => {
    ...
    return (
        <div className="p-8  mx-auto space-y-12 animate-in fade-in zoom-in duration-500">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white shadow-sm p-8 rounded-[2.5rem] flex-1 border border-gray-100">
                            <div className="flex items-center justify-between border-b border-gray-100 pb-4 mb-4">
                                <h3 className="text-sm font-black uppercase text-slate-900">Participants ({participants.length})</h3>
                            </div>
